...
export const dataSource: IDataSourceItem[] = [
  ...
  },
  {
    ...
    state: EnumHostStates.RED,
    description:
      'Join the conversation, follow accounts, see your Home Timeline, and catch up on Tweets from the people you know.',
  },
  {
    id: '3',
  ...
  },
  {
    ...
    state: EnumHostStates.GREEN,
    description:
      'Elasticsearch. The fast and scalable search and analytics engine at the heart of the Elastic Stack. logo-kibana- ...',
  },
  {
    id: '5',
  ...
  },
  {
    ...
    state: EnumHostStates.GREEN,
    description:
      'AngularJS is a toolset for building the framework most suited to your application development. It is fully extensible and works well with other libraries. Every ...',
  },
  {
    id: '7',
    hostName: 'vuejs.org',
  ...
  },
  {
    ...
    state: EnumHostStates.GREEN,
    description:
      "TortoiseSVN is an Apache Subversion (SVN) client, implemented as a Windows shell extension. It's intuitive and easy to use, since it doesn't require the ...",
  },
  {
    id: '13',
    ...
    state: EnumHostStates.YELLOW,
    description:
      'Relied upon by more than 11 million developers worldwide, npm is committed to making JavaScript development elegant, productive, and safe. The free npm Registry ...',
  },
  {
    id: '14',
